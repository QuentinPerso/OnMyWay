...
//        #imageLiteral(resourceName: "Lion").draw(in: CGRect(x: rPad, y: rPad, width: width - 2*rPad, height: width - 2*rPad))
        ...
        let width = self.bounds.width
        let rPad = width/5
        let label = UILabel(frame: CGRect(x: rPad*3/4, y: rPad, width: width - 2*rPad*3/4, height: width - 2*rPad))
        ...
        label.drawText(in: CGRect(x: rPad*3/4, y: rPad, width: width - 2*rPad*3/4, height: width - 2*rPad))
